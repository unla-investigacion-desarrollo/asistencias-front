...
import { OBTENER_CONTENIDOS_PUBLICOS, DETALLE_CONTENIDO, OBTENER_EVENTOS_PUBLICOS, TRAER_CONTENIDOS_X_EVENTO, TRAER_CONTENIDOS_X_TITULO } from '../store/actions-types';
