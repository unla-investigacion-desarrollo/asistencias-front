...
<script>
import { EDITAR_AUDIO, ELIMINAR_AUDIO, ACEPTA_ELIMINAR_AUDIO } from '../store/actions-types';
import MensajeComponent from './MensajeComponent.vue';
export default {
  name: 'ListaContenidoAudio',
  ...
  computed: {
    audios() {
      return this.$store.getters.getContenido().audios;
    },
    elimino(){
